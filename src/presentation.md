...
.right-column[
.brendan-img[![Brendan Eich picture](./assets/img/brendan_eich.jpg)]
...
.right-column[
### React native
.react-native-img[![React Native logo](./assets/img/react-native.png)]
Développé par Facebook  
S'appuie sur React <small>doh</small>  
Génère des applications iOS, Android

### Ionic
.ionic-img[![Ionic logo](./assets/img/ionic.svg)]
Développé par Drifty  
S'appuie sur Angular  
Génère des applications iOS, Android, UWP, Web et Electron
]

.right-column[
Tous les deux s'appuient sur les SDK natifs  
➡ bien meilleures performances et "feeling" que les applications hybrides
]
...
.right-column[
### Des projets ~~bizarres~~
- [Cypress](https://www.cypress.io/), un IDE pour faire des tests end-to-end
- [Hyper](https://hyper.is/) : un terminal, fait avec Electron
- [WebTorrent](https://webtorrent.io/) (compatible avec les vrais torrents via un serveur "bridge")
- [NodeOS](http://node-os.com/), un OS en JavaScript

### Plus loin que le JS
- [TypeScript](http://www.typescriptlang.org/), [Flow](https://flow.org/), [Dart](https://www.dartlang.org/), [Elm](http://elm-lang.org/), [ReasonML](https://reasonml.github.io/), [Kotlin](https://kotlinlang.org/)... qui compilent vers du JS
- [WebAssembly](http://webassembly.org/) : un format d'exécutable binaire implémenté dans les navigateurs (à partir de C, Rust...)
]
...
- Le protocole [WebTorrent](https://github.com/webtorrent/webtorrent)
